...
if args.input =='illumina':
    ...
    # chewBBACA
        ...
        subprocess.call("chewBBACA.py AlleleCall -i ./chewbbca/ -g " + TOOL_DIR + "/data/schema_chewBBACA_cgMLST_V4 -o chewbacca_results/ --cpu 6 --bsr 0.6 --ptf /afs/galaxy/tools/INNUENDO/chewBBACA_2.0/TrainingFiles4Prodigal/trained_eColi.trn --fr", shell=True)
...
if args.input=='ion':
    ...
    #chewBBACA
        ...
        subprocess.call("mkdir chewbbca", shell=True)
        subprocess.call("cp " + sample + "_contigs ./chewbbca/" + sample + "_contigs.fasta",shell=True)
        subprocess.call("python "+chewbbca+"chewBBACA.py AlleleCall -i ./chewbbca/ -g " + TOOL_DIR + "/data/schema_chewBBACA_cgMLST_V4 -o chewbacca_results/ --cpu 6 --bsr 0.6 --ptf /afs/galaxy/tools/INNUENDO/chewBBACA_2.0/TrainingFiles4Prodigal/trained_eColi.trn --fr", shell=True)
        subprocess.call("cp chewbacca_results/results_*/results_statistics.tsv ./chewbbca_results.tsv", shell=True)
        subprocess.call("cp chewbacca_results/results_*/results_alleles.tsv ./results_alleles.tsv", shell=True)
        subprocess.call("cp chewbacca_results/results_*/RepeatedLoci.txt ./RepeatedLoci.txt", shell=True)
        os.chdir('../')
