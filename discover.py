...
if args.input =='illumina':
    ...
    # chewBBACA
        ...
        subprocess.call("chewBBACA.py AlleleCall -i ./chewbbca/ -g " + TOOL_DIR + "/data/schema_chewBBACA_cgMLST_V4 -o chewbacca_results/ --cpu 6 --bsr 0.6 --ptf " + TOOL_DIR + "/data/schema_chewBBACA_cgMLST_V4/trained_eColi.trn --fr", shell=True)
