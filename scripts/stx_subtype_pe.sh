...
# FILTER + ASSEMBLY
$tooldir/scripts/duk/duk -m stxdir/filtered1STX.fq -k 23 $tooldir/data/stx.fasta $fastqfile1;
$tooldir/scripts/duk/duk -m stxdir/filtered2STX.fq -k 23 $tooldir/data/stx.fasta $fastqfile2;
$tooldir/scripts/fastq-pair-master/build/fastq_pair stxdir/filtered1STX.fq stxdir/filtered2STX.fq;
$tooldir/scripts/fastq-pair-master/build/fastq_pair stxdir/filtered1STX.fq.single.fq $fastqfile2;
